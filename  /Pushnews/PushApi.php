...
class PushApi
{
     ...
     * @param \Pushnews\Notification $body Notification object (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Pushnews\ApiResponse
     */
     ...
     * @param \Pushnews\Notification $body Notification object (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Pushnews\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pushSendWithHttpInfo($siteId, $body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Pushnews\ApiResponse',
                '/push/{siteId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Pushnews\ApiResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Pushnews\ApiResponse', $e->getResponseHeaders());
